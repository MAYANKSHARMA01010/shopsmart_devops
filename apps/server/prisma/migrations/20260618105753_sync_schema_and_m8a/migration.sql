...
-- CreateEnum
CREATE TYPE "PaymentGatewayProvider" AS ENUM ('RAZORPAY', 'STRIPE');

-- CreateEnum
CREATE TYPE "PaymentTransactionStatus" AS ENUM ('PENDING', 'CAPTURED', 'FAILED', 'REFUNDED');
...
-- CreateIndex
CREATE INDEX "order_audit_logs_orderId_idx" ON "order_audit_logs"("orderId");

-- CreateIndex
CREATE INDEX "order_audit_logs_actorId_idx" ON "order_audit_logs"("actorId");
...
-- AddForeignKey
ALTER TABLE "order_audit_logs" ADD CONSTRAINT "order_audit_logs_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "orders"("id") ON DELETE CASCADE ON UPDATE CASCADE;
